var rule = {
    ...
    一级: $js.toString(()=>{
        ...
        list.forEach(it => {
            ...
            url:id,
            title:it.name,
            img:'https://q1.itc.cn/images01/20241207/3e9a19cbd1464d268cfcc7b2b73ab0f7.jpeg',
            desc:it.des,
        })
        })
       setResult(d);
    ...
    VOD = {
            vod_pic : 'https://q1.itc.cn/images01/20241207/3e9a19cbd1464d268cfcc7b2b73ab0f7.jpeg',
            vod_play_from: '梨园行戏曲',
